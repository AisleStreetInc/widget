!(function () {
  ...
  if (
    ...
    i.style.zIndex = "10000000";
    i.style.setProperty("z-index", "10000000", "important");
    ...
    style.type = "text/css";
    var css =
      "#ch-plugin { position: relative !important; display: block !important; color-scheme: normal !important; white-space: normal !important; z-index: 10000000 !important; } #ch-plugin-script { box-shadow: rgba(255, 255, 255, 0.12) 0px 0px 2px 0px inset, rgba(0, 0, 0, 0.05) 0px 0px 2px 1px, rgba(0, 0, 0, 0.3) 0px 12px 60px; width: 390px !important; min-height: 200px !important; max-height: 690px !important; overflow: hidden !important; background-color: transparent !important; border-radius: 30px !important; will-change: transform, opacity !important; bottom: 90px !important; right: 24px !important; height: calc(100% - 110px) !important; position: fixed !important; transition: opacity 0.5s, transform 0.5s, visibility 0.5s; transform: translateY(0); opacity: 1; } .ch-plugin-script-off { transform: translateY(20px) !important; opacity: 0 !important; visibility: hidden !important; transition: opacity 0.5s, transform 0.5s, visibility 0.5s 0.5s; } #ch-plugin-launcher { position: fixed; z-index: 10; display: flex; justify-content: center; align-items: center; flex-wrap: nowrap; width: auto; overflow: visible; background: transparent; bottom: 24px; right: 24px; } #ch-plugin-launcher-button { width: 54px; height: 54px; border: 0; border-radius: 20px; box-shadow: rgba(255, 255, 255, 0.12) 0px 0px 2px 0px inset, rgba(0, 0, 0, 0.05) 0px 0px 2px 1px, rgba(0, 0, 0, 0.3) 0px 12px 60px; padding: 0; display: flex; justify-content: center; align-items: center; } #ch-plugin-launcher-on svg { width: 36px; height: 36px; } #ch-plugin-launcher-off svg { width: 32px; height: 32px; }";
    if (style.styleSheet) {
    ...
    var t = document.getElementById("ch-plugin-script-iframe"),
      ...
      o = function () {
        ...
        e.open(),
          e.write(
            '<link rel="stylesheet" href="https://raw.githubusercontent.com/AisleStreetInc/widget/main/app/app.css">'
          ),
          e.write(
            '<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-icons/1.10.0/font/bootstrap-icons.min.css">'
          ),
          e.write(
            '<script async type="text/javascript" src="https://raw.githubusercontent.com/AisleStreetInc/widget/main/app/app.js" charset="UTF-8"></script>'
          ),
          e.write(
